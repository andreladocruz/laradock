...
alias artclear="php artisan cache:clear && php artisan route:clear && php artisan view:clear && php artisan config:clear"
...
alias npm:watch="npm run watch-poll"
alias npm:dev="npm run dev"
alias npm:prod="npm run prod"
