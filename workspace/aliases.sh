...
alias clearcache="php artisan cache:clear && php artisan route:clear && php artisan view:clear && php artisan config:clear"
...
alias npm:install="npm install && npm run dev"
